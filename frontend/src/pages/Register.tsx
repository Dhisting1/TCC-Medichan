...
const ROLES: Role[] = [
  {
    ...
    label: "Paciente",
    Icon: User,
    extra: { field: "cpf", label: "CPF", placeholder: "000.000.000-00" },
  },
  {
    value: "DOCTOR",
    label: "Médico",
    Icon: Stethoscope,
    extra: { field: "crm", label: "CRM", placeholder: "CRM-UF 000000" },
  },
  {
    value: "PHARMACY",
    label: "Farmácia",
    Icon: Building2,
    extra: { field: "cnpj", label: "CNPJ", placeholder: "00.000.000/0001-00" },
  },
];
...
export default function Register() {
  ...
  async function handleRegister(e: any) {
    ...
    if (!extra.trim()) {
      setError(`${selected.extra.label} é obrigatório.`);
      return;
    }

    // valida CPF antes de mandar pro backend
    if (role === "PATIENT" && !isValidCpf(extra)) {
  ...
  return (
    <Page>
      <LeftPanel>
        ...
        <Tagline>
          Sistema de E-Prescription
          <br />
          com Blockchain
        </Tagline>
        <TaglineSub>
          Segurança, rastreabilidade e autenticidade para prescrições médicas
          digitais.
        </TaglineSub>
        <InfoCard>
          <p>
            <strong>Pacientes</strong> têm acesso imediato após o cadastro.
            <br />
            <br />
        ...
        <FormBox>
          ...
          {needsApproval && (
            <NoticeBanner>
              ...
              <span>
                Contas de <strong>{selected.label}</strong> ficam pendentes até
