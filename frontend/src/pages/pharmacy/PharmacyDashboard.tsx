...
import type { PatientData } from "../../components/PatientSearch";
import {
  TEAL, LIME, WHITE, BORDER, MUTED, SUBTLE,
  STATUS_COLORS, STATUS_LABELS,
} from "../../styles/tokens";
import {
  Search, Pill, ClipboardList,
...
const CardHeader = styled.div`
  ...
  padding: 16px 24px; background: ${SUBTLE};
...
const InfoArea = styled.div`
  margin: 0 24px 20px; min-height: 130px;
...
// ── interfaces ────────────────────────────────────────────────────────────────
interface Presc {
  id: string; patient: string; medication: string;
  dosage: string; status: string; createdAt: string; updatedAt?: string;
}
    ...
    <Layout>
      ...
      {tab === "validate" && (
        <PageGrid>
          <Card>
            <CardHeader>
              <HeaderIcon><Search size={18} strokeWidth={2} /></HeaderIcon>
              <div>
            ...
            <SearchRow>
              ...
              <SearchBtn onClick={handleSearch} disabled={searching}>
                {searching ? "..." : <Search size={15} strokeWidth={2.2} />}
              </SearchBtn>
            </SearchRow>
            ...
            {found ? (
              ...
              <InfoArea>
                <PlaceholderText>INFORMAÇÕES CONTIDAS NA RECEITA</PlaceholderText>
              </InfoArea>
            )}
      ...
      {tab === "active" && (
        <PageGrid>
          <Card>
            <CardHeader>
              <HeaderIcon><Pill size={18} strokeWidth={2} /></HeaderIcon>
      ...
      {tab === "history" && (
        <Card>
          <CardHeader>
            <HeaderIcon><ClipboardList size={18} strokeWidth={2} /></HeaderIcon>
